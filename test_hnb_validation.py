...
logger = logging.getLogger("HNB_Validator")

def run_test():
    logger.info("Initializing A697 HNB OCR Integration Test...")
    ...
    test_img_name = "1ebed988-00c3fb728099e272_jpg.rf.c9b76d16d45caa7c8cd5c16502d16ba9.jpg"
    test_img_path = os.path.join("dataset", "images", "val", test_img_name)
    ...
    for det in detections:
        ...
        if det['class'] == 'Number plate':
            ...
            if easy_text == "A697 HNB" and tess_text == "A697 HNB":
                logger.info("SUCCESS: Both EasyOCR and Tesseract OCR successfully resolved to 'A697 HNB'!")
                passed = True
            else:
                logger.error(f"FAILURE: OCR text mismatch. Expected 'A697 HNB', got EasyOCR='{easy_text}', Tesseract='{tess_text}'")
